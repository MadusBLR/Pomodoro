...
import com.mycompany.pomodoro.R
...
class ProgressCircle @JvmOverloads constructor(
    ...
    init {
        if (attrs != null) {
            ...
            color = styledAttrs.getColor(R.styleable.ProgressCircle_custom_color, Color.RED)
            style = styledAttrs.getInt(R.styleable.ProgressCircle_custom_style, FILL)
            styledAttrs.recycle()
        }
